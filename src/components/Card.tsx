                        ...
                        <div className="pt-2">
                            ...
                            >
                                <svg className="w-4 h-4 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                    <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l.8 2.47a1 1 0 00.95.69h2.59c.969 0 1.371 1.24.588 1.81l-2.097 1.525a1 1 0 00-.363 1.118l.8 2.47c.3.922-.755 1.688-1.538 1.118l-2.097-1.525a1 1 0 00-1.176 0l-2.097 1.525c-.783.57-1.838-.196-1.538-1.118l.8-2.47a1 1 0 00-.363-1.118l-2.097-1.525c-.783-.57-.38-1.81.588-1.81h2.59a1 1 0 00.951-.69l.8-2.47z"></path>
                                </svg>
                                Link na Dysk
                            </a>
                        </div>
