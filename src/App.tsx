                    ...
                    {authLoading ? (
                        ...
                        <>
                            <input
                                ...
                                className="input input-bordered bg-gray-700 text-white input-sm w-24 sm:w-32"
                            />
                            ...
                            <span className="text-white text-xs sm:text-sm whitespace-nowrap">{currentUser.username.split('@')[0]}</span>
                        </>
                    )}
                </div>
            </header>
